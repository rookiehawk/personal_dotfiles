...
export GOPATH=/home/chaos/Me/code/goProjects
...
export FZF_DEFAULT_OPTS="--height 40% --border --layout=reverse --preview '(highlight -O ansi {} || cat {}|| tree -C {}) 2> /dev/null | head -500'"
